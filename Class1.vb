...
Public Class Class1
    Public Function Loadkhachang() As DataSet
        Dim chuoiketnoi As String = "workstation id=ps03856.mssql.somee.com;packet size=4096;user id=hoangmy96_SQLLogin_1;pwd=mhptmv2vsz;data source=ps03856.mssql.somee.com;persist security info=False;initial catalog=ps03856"
